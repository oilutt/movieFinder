...
public interface RestApi {
    ...
    Observable<DiscoverResponse> getMovies(@Query("api_key") String apiKey, @Query("language") String language, @Query("include_adult") Boolean adult, @Query("release_date.lte") String date, @Query("page") Integer page);
    ...
    @GET(Constants.Retrofit.DISCOVER_MOVIES)
    Observable<DiscoverResponse> getMoviesOrderBy(@Query("api_key") String apiKey, @Query("sort_by") String sortBy, @Query("language") String language, @Query("include_adult") Boolean adult, @Query("release_date.lte") String date, @Query("page") Integer page);
}
